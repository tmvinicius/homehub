...
import br.com.tmvinicius.home.hub.domain.usecase.auth.GetCurrentUserUseCaseImpl;
...
public class UseCaseConfig {
    ...
    @Bean
    public GetCurrentUserUseCase getCurrentUserUseCase(TokenProvider tokenProvider){
        return new GetCurrentUserUseCaseImpl(tokenProvider);
    }
